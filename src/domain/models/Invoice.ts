...
export function createEmptyInvoice(id: string, clientId = ""): Invoice {
  return {
    ...
    paymentTermsDays: 14,
    dueDate: undefined,
    sellerCountry: "DE", customerCountry: "DE", customerType: "BUSINESS", serviceCountry: "DE", currency: "EUR",
    positions: [],
    vatRate: 0,
...
export function normalizeInvoice(invoice: Invoice): Invoice {
  return {
    ...
    sellerCountry: invoice.sellerCountry ?? "DE", customerCountry: invoice.customerCountry ?? "DE", customerType: invoice.customerType ?? "BUSINESS", serviceCountry: invoice.serviceCountry ?? "DE", currency: invoice.currency ?? "EUR",
