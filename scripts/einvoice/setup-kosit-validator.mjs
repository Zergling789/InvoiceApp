...
const unzip=spawnSync("tar",["-xf",path.join(cache,artifacts[1].name),"-C",config],{stdio:"inherit"});if(unzip.status!==0)throw new Error("Validator-Konfiguration konnte nicht entpackt werden (tar erforderlich).");
