...
revoke all on function public.list_offer_documents_page(text, uuid[], text[], timestamptz, uuid, integer) from public, anon;
revoke all on function public.list_invoice_documents_page(text, uuid[], text[], timestamptz, uuid, date, integer) from public, anon;

grant execute on function public.list_offer_documents_page(text, uuid[], text[], timestamptz, uuid, integer) to authenticated, service_role;
grant execute on function public.list_invoice_documents_page(text, uuid[], text[], timestamptz, uuid, date, integer) to authenticated, service_role;
